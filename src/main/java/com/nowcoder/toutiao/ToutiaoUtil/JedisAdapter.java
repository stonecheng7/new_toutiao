...
import com.nowcoder.toutiao.controller.IndexController;
...
//        print(10, jedis.linsert(listName, BinaryClient.LIST_POSITION.BEFORE, "a4", "bb"));
    ...
    public String get(String key) {
        ...
        try {
            ...
            logger.error("发生异常o" + e.getMessage());
            return null;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public void set(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常i" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public long sadd(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常u" + e.getMessage());
            return 0;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public long srem(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常y" + e.getMessage());
            return 0;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public boolean sismember(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常t" + e.getMessage());
            return false;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public long scard(String key) {
        ...
        try {
            ...
            logger.error("发生异常r" + e.getMessage());
            return 0;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public void setex(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常e" + e.getMessage());
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public long lpush(String key, String value) {
        ...
        try {
            ...
            logger.error("发生异常w" + e.getMessage());
            return 0;
        } finally {
            if (jedis != null) {
                jedis.close();
    ...
    public List<String> brpop(int timeout, String key) {
        ...
        try {
            ...
            logger.error("发生异常sssssss" + e.getMessage());
            return null;
        } finally {
            if (jedis != null) {
                jedis.close();
